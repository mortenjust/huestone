package com.mortenjust.huestone.data;
...
public class AccessPointListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(com.mortenjust.huestone.R.layout.selectbridge_item, null);

            item = new BridgeListItem();
            item.bridgeMac = (TextView) convertView.findViewById(com.mortenjust.huestone.R.id.bridge_mac);
            item.bridgeIp = (TextView) convertView.findViewById(com.mortenjust.huestone.R.id.bridge_ip);
